...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.shield = True
        self.shieldSurf = pygame.image.load("plataformJump/my-sprites/shield-big.png")
    ...
    def load_animation(self, name):
        ...
        asset = pygame.image.load("plataformJump/sprites/2 Punk/Punk_" + name + ".png").convert_alpha()
