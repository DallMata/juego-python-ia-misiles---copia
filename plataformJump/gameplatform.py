...
class GamePlatform(pygame.sprite.Sprite):
    def __init__(self, tileNumber, x):
        ...
        platformImageSurf_unique = pygame.image.load("plataformJump/sprites/1 Tiles/" + tiles[tile_idx]["unique"]).convert_alpha()
        platformImageSurf_beginning = pygame.image.load("plataformJump/sprites/1 Tiles/" + tiles[tile_idx]["beginning"]).convert_alpha()
        platformImageSurf_middle = pygame.image.load("plataformJump/sprites/1 Tiles/" + tiles[tile_idx]["middle"]).convert_alpha()
        platformImageSurf_end = pygame.image.load("plataformJump/sprites/1 Tiles/" + tiles[tile_idx]["end"]).convert_alpha()
        ...
        if "beginning_bottom" in tiles[tile_idx]:
            platformImageSurf_beginning_bottom = pygame.image.load("plataformJump/sprites/1 Tiles/" + tiles[tile_idx]["beginning_bottom"]).convert_alpha()
            platformImageSurf_middle_bottom = pygame.image.load("plataformJump/sprites/1 Tiles/" + tiles[tile_idx]["middle_bottom"]).convert_alpha()
            platformImageSurf_end_bottom = pygame.image.load("plataformJump/sprites/1 Tiles/" + tiles[tile_idx]["end_bottom"]).convert_alpha()
